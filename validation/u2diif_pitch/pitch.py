...
k = 10/np.pi          # Reduced pitch frequency (k=1: 1osc. per tau)
freq = k/tau          # Pitch frequency (Hz)
pamp = .01*180/np.pi  # Pitch amplitude (degrees)
...
gait = ubem.fourier_pitch_heave(time, freq, pamp)
...
# Post processing
# ------------------------------------------------------------
u2diif_100CD = ubem.read_data(os.path.join(this_dir, 'u2diif_100CD.txt'))
