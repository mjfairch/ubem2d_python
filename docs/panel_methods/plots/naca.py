...
if __name__ == '__main__':
    ...
    plt.figure()
    plt.plot(foil.x, foil.y,'k-s')
    plt.axis('equal')
    plt.grid(True)
    plt.xlabel(r'$x$')
    plt.ylabel(r'$y$')
    plt.title('NACA {} with {} panels at {} degrees'.format(code,npan,aoa_deg))
    plt.savefig(os.path.join(thisdir, 'naca_panels.pdf'.format(code)))
    ...
    plt.grid(True)
    plt.savefig(os.path.join(thisdir, 'naca_cp_boundary.pdf'))
    ...
    plt.title('Pressure field (Cp), NACA {} at {} degrees'.format(code,
        aoa_deg))
    plt.savefig(os.path.join(thisdir,'naca_cp_field.pdf'))
    ...
    plt.axis('equal')
    plt.savefig(os.path.join(thisdir, 'naca_streamlines.pdf'))
